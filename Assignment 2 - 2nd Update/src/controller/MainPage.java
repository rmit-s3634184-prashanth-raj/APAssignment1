...
public class MainPage 
{
	...
	private void initialize() 
	{
		try
		{
			...
			mainPageTextarea.setText("Current status of the network:");
			...
			//displayAllProfileDetails();
			//addPersonIntoNetworkFn();
			/*
			findConnections.setOnAction((event) ->
			{
				mainPageTextarea.setText("Find connections is clicked");
			});
			*/
	...
	{
		mainObj.toAndFromNavigation("DeleteProfile");
	}
	...
	/*
	private static void displayAllProfileDetails()
	{
		try
		{
			for( int i = 0; i < CreatePeople.getListOfAdult().size(); i ++  )
		...
		{
			mainPageTextarea.appendText("\n[Menu]displayAllProfileDetails: " + e.getMessage());
		}
	}
	*/
}
