...
public class CreatePeople 
{
	...
	public static String getPersonIdByProflieName(String name)
	{
		...
		try
		{
			System.out.println("getPersonIdByProflieName<><@#@#><#$>");
			for( int i = 0; i < CreatePeople.listOfProfile.size(); i ++)
			{
				if( CreatePeople.listOfProfile.get(i).getProfileName().equalsIgnoreCase(name) )
				{
					System.out.println("CreatePeople.listOfProfile.get(i).getProfileName()>> " + CreatePeople.listOfProfile.get(i).getProfileName());
					System.out.println("CreatePeople.listOfProfile.get(i).getPersonId();>>>>>> " + CreatePeople.listOfProfile.get(i).getPersonId());
