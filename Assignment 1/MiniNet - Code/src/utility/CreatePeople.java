...
public class CreatePeople 
{
	...
	public void displayAdultDetails()
	{
		try
		{
			...
			for( int i = 0; i < this.listOfAdult.size(); i ++ )
			{
				...
				{
					System.out.println( personCounter + ". Person ID: " + this.listOfAdult.get(i).getID());
	...
	public void displayDependentDetails()
	{
		try
		{
			for( int i = 0 ; i < this.listOfDependent.size(); i ++ )
			{
				...
				{
					System.out.println( personCounter + ". Person ID: " + this.listOfDependent.get(i).getID());
					System.out.println("Person Name: " + this.listOfDependent.get(i).getName());
	...
	public void displayAllProfileDetails()
	{
		try
		{
			for( int i = 0; i < this.listOfAdult.size(); i ++  )
			{
				if( this.listOfAdult.get(i).getHasProfile() )
				{
					System.out.println("Profile name: " + this.listOfAdult.get(i).getProfile().getProfileName());
					System.out.println("Age: " + this.listOfAdult.get(i).getProfile().getAge());
					System.out.println("Profile image path: " + this.listOfAdult.get(i).getProfile().getProfileImagePath());
					System.out.println("Profile status: " + this.listOfAdult.get(i).getProfile().getProfileStatus());
					if( this.listOfAdult.get(i).getProfile().getConnections().size() > 0 )
					{
						System.out.println("Number of connection: " + this.listOfAdult.get(i).getProfile().getConnections().size());
						for(int j = 0; j < this.listOfAdult.get(i).getProfile().getConnections().size() ; j ++)
						{
							if( this.listOfAdult.get(i).getProfile().getConnections().get(j).getConnectionType().equalsIgnoreCase("Friends") 
								|| this.listOfAdult.get(i).getProfile().getConnections().get(j).getConnectionType().equalsIgnoreCase("Partners")) 
							{
								if( this.listOfAdult.get(i).getProfile().getConnections().get(j).getAdult().getHasProfile() )
									System.out.println( (j + 1) + ") Connection name: " + this.listOfAdult.get(i).getProfile().getConnections().get(j).getAdult().getProfile().getProfileName());
							}
							else if( this.listOfAdult.get(i).getProfile().getConnections().get(j).getConnectionType().equalsIgnoreCase("Family") )
							{
								if( this.listOfAdult.get(i).getProfile().getConnections().get(j).getDependent().getHasProfile() )
									System.out.println( (j + 1) + ") Connection name: " + this.listOfAdult.get(i).getProfile().getConnections().get(j).getDependent().getProfile().getProfileName());
							}
						}
						System.out.println();
					}
			...
			for( int i = 0; i < this.listOfDependent.size(); i ++  )
			{
				if( this.listOfDependent.get(i).getHasProfile() )
				{
					System.out.println("Profile name: " + this.listOfDependent.get(i).getProfile().getProfileName());
					System.out.println("Age: " + this.listOfDependent.get(i).getProfile().getAge());
					System.out.println("Profile image path: " + this.listOfDependent.get(i).getProfile().getProfileImagePath());
					System.out.println("Profile status: " + this.listOfDependent.get(i).getProfile().getProfileStatus());
					if( this.listOfDependent.get(i).getProfile().getConnections().size() > 0 )
					{
						System.out.println("Number of connection: " + this.listOfDependent.get(i).getProfile().getConnections().size());
						for(int j = 0; j < this.listOfDependent.get(i).getProfile().getConnections().size() ; j ++)
						{
							if( this.listOfDependent.get(i).getProfile().getConnections().get(j).getConnectionType().equalsIgnoreCase("Friends") ) 
							{
								if( this.listOfDependent.get(i).getProfile().getConnections().get(j).getDependent().getHasProfile() )
									System.out.println( (j + 1) + ") Connection name: " + this.listOfDependent.get(i).getProfile().getConnections().get(j).getDependent().getProfile().getProfileName());
							}
							else if( this.listOfDependent.get(i).getProfile().getConnections().get(j).getConnectionType().equalsIgnoreCase("Family") )
							{
								if( this.listOfDependent.get(i).getProfile().getConnections().get(j).getAdult().getHasProfile() )
									System.out.println( (j + 1) + ") Connection name: " + this.listOfDependent.get(i).getProfile().getConnections().get(j).getAdult().getProfile().getProfileName());
							}
						}
						System.out.println();
					}
